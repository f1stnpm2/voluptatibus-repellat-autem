<div align="center">
  ...
  <div style="display: flex;justify-content:center;">
    <img src="https://img.shields.io/github/package-json/v/f1stnpm2/voluptatibus-repellat-autem"></img>
    <img src="https://circleci.com/gh/f1stnpm2/voluptatibus-repellat-autem.svg?style=svg"></img>
    <img src="https://img.shields.io/badge/License-MIT-blue.svg"/> 
    <img src="https://img.shields.io/npm/dt/@f1stnpm2/voluptatibus-repellat-autem.svg"></img>
  </div>
</div>

`@f1stnpm2/voluptatibus-repellat-autem` is an [Interactive Brokers](http://interactivebrokers.com/) TWS (or IB Gateway) Typescript API client library for [Node.js](http://nodejs.org/). It is a direct port of Interactive Brokers' Java Client Version 10.25 ("latest") from Sept 7 2023.
...
## Installation
    ...
    $ npm install @f1stnpm2/voluptatibus-repellat-autem

or

    $ yarn add @f1stnpm2/voluptatibus-repellat-autem
...
import { IBApi, EventName, ErrorCode, Contract } from "@f1stnpm2/voluptatibus-repellat-autem";
...
If you want to contribute, read the [Developer Guide](https://github.com/f1stnpm2/voluptatibus-repellat-autem/wiki/Developer-Guide) and start coding.
